...
public class UsernameTests {
	...
	@Test
	public void usernameWith1Char() throws Exception {
	...
	@Test
	public void usernameMoreThat30Char() throws Exception {
		driver.get("https://svejo.net/register");
		AssertJUnit.assertEquals(driver.getTitle(), "svejo.net | users - new");
		driver.findElement(By.id("user_email")).clear();
		driver.findElement(By.id("user_email")).sendKeys(
	...
	@Test
	public void wrongUsername1() throws Exception {
		driver.get("https://svejo.net/register");
		AssertJUnit.assertEquals(driver.getTitle(), "svejo.net | users - new");
		driver.findElement(By.id("user_email")).clear();
		driver.findElement(By.id("user_email")).sendKeys(
	...
	@Test
	public void wrongUsername2() throws Exception {
		driver.get("https://svejo.net/register");
		AssertJUnit.assertEquals(driver.getTitle(), "svejo.net | users - new");
		driver.findElement(By.id("user_email")).clear();
		driver.findElement(By.id("user_email")).sendKeys(
